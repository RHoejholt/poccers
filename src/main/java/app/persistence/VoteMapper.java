...
public class VoteMapper {
    ...
    public Vote findByVoteID(int voteID) throws SQLException {
    ...
    public void updateRating(int voteID, int newRating) throws SQLException {
        String sql = "UPDATE Vote SET rating = ? WHERE voteID = ?";
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
